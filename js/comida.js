...
fetch('https://api-colombia.com/api/v1/TypicalDish')
    ...
    .then(data => {
        ...
        data.forEach((dato, index) => {
            ...
            contenedorComida.className = 'contenedor-individual';
            contenedorComida.innerHTML = `
                <div class="img-contenedor">
                    <img src="${dato.imageUrl}" alt="${dato.name}" class="ampliar-pantalla-completa" data-index="${index}">
                </div>
                <div class="txt-contenedor">
                    <h2>${dato.name}</h2>
                </div>
            `;
            contenedorGeneral.appendChild(contenedorComida);
        });
                ...
                divPantallaCompleta.innerHTML = `
                    ...
                    <div class="contenedor-informacion">
                            ...
                            <div class="txt-ampliada">
                                ...
                                <h5>Ingredientes: ${info.ingredients || "No disponibles"}</h5>
